...
public class ColorDAOJDBCImpl implements ColorDAO {
    ...
    public Color getColorById(long id) throws DAOException {
        ...
        try(
            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/calendar?serverTimezone=Europe/Paris",
        "meritxell_m03", "1234");
            PreparedStatement sentSQL = connection.prepareStatement("SELECT id, name, red, green, blue FORM colors WHERE id = ?");
        ) {
    ...
    public List<Color> getColors() throws DAOException {
        ...
        try(Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/calendar?serverTimezone=Europe/Paris",
        "meritxell_m03", "1234");
        PreparedStatement sentSQL = connection.prepareStatement("SELECT id, name, red, green, blue FORM colors");
